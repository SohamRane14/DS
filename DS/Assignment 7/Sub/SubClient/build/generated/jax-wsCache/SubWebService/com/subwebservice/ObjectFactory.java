 ...
 * generated in the com.subwebservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Sub_QNAME = new QName("http://subwebservice.com/", "sub");
    private final static QName _SubResponse_QNAME = new QName("http://subwebservice.com/", "subResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.subwebservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://subwebservice.com/", name = "sub")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://subwebservice.com/", name = "subResponse")
